...
public class StaffController {
    ...
    public Result<IPage<StaffChange>> changes(@RequestParam(defaultValue = "1") @Min(1) int pageNum,
    ...
    @PostMapping("/staff/changes") public Result<Void> createChange(@Valid @RequestBody StaffChangeDTO dto) { service.createChange(dto); return Result.success(); }
    @PutMapping("/staff/changes/{id}") public Result<Void> updateChange(@PathVariable Long id, @Valid @RequestBody StaffChangeDTO dto) { service.updateChange(id, dto); return Result.success(); }
