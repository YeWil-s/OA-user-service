...
export const systemApi = {
  ...
  routers: () => http.get<unknown, MenuNode[]>('/api/user/menus/routers')
}
...
export const attendanceApi = {
  ...
  punchIn: (payload?: { punchType?: number; deviceInfo?: string; location?: string }) => http.post<unknown, PunchResult>('/api/attendance/punch/in', payload || {}),
  punchOut: (payload?: { punchType?: number; deviceInfo?: string; location?: string }) => http.post<unknown, PunchResult>('/api/attendance/punch/out', payload || {}),
