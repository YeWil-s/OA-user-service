...
export const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'attendance/record', name: 'attendance-record', component: () => import('@/views/workflows/MockModuleView.vue'), meta: { title: '考勤记录', module: 'attendanceRecords' } },
      { path: 'attendance/shift', name: 'attendance-shift', component: () => import('@/views/workflows/MockModuleView.vue'), meta: { title: '班次管理', module: 'shifts' } },
      { path: 'approval/my-apply', name: 'approval-my', component: () => import('@/views/workflows/MockModuleView.vue'), meta: { title: '我的申请', module: 'applications' } },
      ...
      { path: 'approval/processed', name: 'approval-processed', component: () => import('@/views/workflows/MockModuleView.vue'), meta: { title: '已办审批', module: 'applications' } },
      { path: 'asset/assets', name: 'asset-assets', component: () => import('@/views/workflows/MockModuleView.vue'), meta: { title: '资产台账', module: 'assets' } },
