...
export const routes: RouteRecordRaw[] = [
  { path: '/login', name: 'login', component: () => import('@/views/LoginView.vue'), meta: { public: true } },
  {
    ...
    children: [
      ...
      { path: 'attendance/record', name: 'attendance-record', component: () => import('@/views/workflows/PunchView.vue'), meta: { title: '考勤记录' } },
      ...
      { path: 'approval/my-apply', name: 'approval-my', component: () => import('@/views/workflows/ApplicationListView.vue'), meta: { title: '我的申请', mode: 'mine' } },
      ...
      { path: 'approval/processed', name: 'approval-processed', component: () => import('@/views/workflows/ApplicationListView.vue'), meta: { title: '已办审批', mode: 'processed' } },
